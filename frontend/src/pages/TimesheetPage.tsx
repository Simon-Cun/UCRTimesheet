...
const TimesheetPage = () => {
  ...
  const activeDays = DAYS_OF_WEEK.filter(
    (d) => settings.schedule[d]?.length > 0,
  );
  ...
  const startEdit = async (row: DayRow) => {
    ...
    try {
      const res = await fetch(`/api/timesheet/day?nDate=${row.nDate}`, {
        credentials: "include",
      });
      ...
      setEdit((e) =>
        e ? { ...e, entries: [{ ...BLANK }], loading: false } : null,
      );
    }
  };
  ...
  return (
    <div className="flex-1 bg-neutral-gray100 overflow-y-auto h-full">
      <div className="w-full max-w-4xl mx-auto px-lg py-lg flex flex-col gap-md">
              ...
              {activeDays.length === 0 ? (
                ...
                <div className="flex flex-col gap-sm">
                  {activeDays.map((day) => (
                    ...
                    >
                      <span className="text-sm font-medium text-neutral-gray800 w-28">
                        {day}
                      </span>
                      <div className="flex flex-col items-end gap-xs">
                        {settings.schedule[day].map((e, i) => (
                          <span
                            key={i}
                            className="text-sm text-neutral-gray600 font-mono"
                          >
                ...
                <div className="flex flex-col gap-xs">
                              ...
                              <>
                                {edit.entries.map((entry, i) => (
                                  ...
                                  >
                                    ...
                                    <span className="text-neutral-gray500 text-sm">
                                      –
                                    </span>
                                    <input
                                      type="text"
                  ...
                  <div className="flex items-center gap-md mt-sm pt-sm border-t border-neutral-gray100 flex-wrap">
                    <div className="flex items-center gap-xs">
                      ...
                      <span className="text-xs text-neutral-gray400">
                        Scheduled
                      </span>
                    </div>
                    <div className="flex items-center gap-xs">
        ...
        <p className="text-center text-xs text-neutral-gray500 pb-lg">
          UCR Timesheet Bot — your schedule is saved locally
        </p>
      </div>
    </div>
  );
